...
const Row6 = ({ data, className = "space-y-5" }) => {
                ...
                {active && rowData && (
                    ...
                    >
                        ...
                        <div style={{ display: 'flex' }}>
                                <p style={{ width: '350px', textAlign: 'left', marginRight: '10px', fontWeight: 'bold' }}>Have you had any previous orthopaedic surgery ?</p>
                                <p style={{ width: '600px', marginRight: '10px' }}>: {rowData.PorthopaedicS}</p>
                            </div>
                            <div style={{ display: 'flex' }}>
                                <p style={{ width: '350px', textAlign: 'left', marginRight: '10px', fontWeight: 'bold' }}>Have you ever had complications after surgery ?</p>
                                <p style={{ width: '600px', marginRight: '10px' }}>: {rowData.ComplicationsAS}</p>
                            </div>
                        </div>
